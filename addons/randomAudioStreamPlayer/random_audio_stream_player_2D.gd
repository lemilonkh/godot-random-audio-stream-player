...
@export_dir var select_samples_from_folder: set = load_samples_from_folder
...
@export_range(0, 80) var random_volume_range = 0
@onready var base_pitch = pitch_scale
@export_range(0, 4) var random_pitch_range = 0
